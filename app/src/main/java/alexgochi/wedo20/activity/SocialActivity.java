...
public class SocialActivity extends Counter implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.activity_social);
        mToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.drawer_open, R.string.drawer_close);
        mDrawerLayout.addDrawerListener(mToggle);
        mToggle.syncState();
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);

        navigationView = (NavigationView) findViewById(R.id.nav_social);
    ...
    public void onBackPressed() {
        Intent intent_tomorrow = new Intent(SocialActivity.this, MainActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.today_act) {
            Intent in_today = new Intent(SocialActivity.this, TodayActivity.class);
            ...
            Intent in_tomorrow = new Intent(SocialActivity.this, TomorrowActivity.class);
            Toast.makeText(getApplicationContext(), "Swipe Right to Delete", Toast.LENGTH_SHORT).show();
            startActivity(in_tomorrow);
            finish();
        } else if (id == R.id.important_act) {
            Intent in_important = new Intent(SocialActivity.this, ImportantActivity.class);
            Toast.makeText(getApplicationContext(), "Swipe Right to Delete", Toast.LENGTH_SHORT).show();
            startActivity(in_important);
            finish();
        } else if (id == R.id.work_act) {
            Intent in_work = new Intent(SocialActivity.this, WorkActivity.class);
            Toast.makeText(getApplicationContext(), "Swipe Right to Delete", Toast.LENGTH_SHORT).show();
